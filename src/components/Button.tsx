...
type ButtonProps = {
  children: ReactNode;
  variation: "primary" | "small" | "secondary" | "round";
  disabled?: boolean;
...
function Button({
  ...
  const base =
    "inline-block  text-sm focus:ring-0 focus:ring-offset-0 font-semibold tracking-wide uppercase transition-all duration-250 bg-sky-400 rounded-full disabled:cursor-not-allowed hover:bg-lime-300 text-stone-700 btn shadow-[0_7px_0_rgb(0,0,0)] hover:shadow-[0_5px_0px_rgb(0,0,0)] active:shadow-[0_1px_0_rgb(0,0,0)] hover:translate-y-1 dark:text-gray-100 dark:bg-sky-500 dark:hover:bg-lime-600 ";
